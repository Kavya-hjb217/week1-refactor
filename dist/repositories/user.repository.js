import { ok, err } from "../utils/result.helpers.js";
...
export class UserRepository {
    ...
    delete(id) {
        if (!this.users.has(id))
            return err("UserNotFound"); //has() is a js method to checkexistence of a key in the Map
